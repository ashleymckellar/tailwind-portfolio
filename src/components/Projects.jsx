...
const Projects = () => {
    return (
        <div className="p-20 my-20 flex-col justify-between " id="Projects">
            <h3 className='py-10 text-center text-xl'>A Few Accomplishments</h3>
            <article className='flex flex-col items-center w-full'>
                <a href="https://sidhu-farms1.vercel.app/" className="image">
                    <img src={SidhuFarmsimg} alt="" className="mx-auto w-150 h-80 object-cover" />
                </a>
            ...
            <article className='flex flex-col items-center w-full'>
                <a href="https://www.djbentleytaylor.com/" >
                    <img src={DJBentley} alt="" className="mx-auto w-150 h-80 object-cover" />
                </a>
                <div className="py-10 text-center">
                    <h4 className='text-2xl'>DJ Bentley Taylor</h4>
            ...
            <article className='flex flex-col items-center w-full'>
                <a href="https://hotsauce-world.com">
                    <img src={HotSauce} alt="" className="mx-auto w-150 h-80 object-cover"/>
                </a>
                <div className="py-10 text-center">
